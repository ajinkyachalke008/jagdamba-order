  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { 
            ...
            filter: "drop-shadow(0 0 10px hsl(24 100% 50% / 0.4))"
          },
          "50%": { 
            boxShadow: "0 0 40px hsl(24 100% 50% / 0.8)",
        ...
        "fly-to-cart": {
          ...
          "100%": { transform: "translate(300px, -200px) scale(0.3)", opacity: "0" },
        },
        "shuffle": {
          "0%": { transform: "translateX(0) rotateY(0deg)", opacity: "1" },
          "50%": { transform: "translateX(-50px) rotateY(90deg)", opacity: "0.5" },
      ...
      animation: {
        ...
        "fly-to-cart": "fly-to-cart 0.6s ease-in-out",
